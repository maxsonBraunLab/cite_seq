...
# Load Seurat objects
exptsList <- readRDS(sprintf("%s/clustered_all_samples.%s.%s.rds", directory$rda, projectName,importDate))
...
### Reference-Based UMAP Cluster Annotation (CHETAH)
...
#### CHETAH UMAP Cluster Annotation
...
### CHETAH UMAP Cluster Annotation Plots {.tabset}

`r i <- 1`
#### `r toupper(names(exptsList)[i])`

##### CHETAH Cell Type Prediction (Primary Cell Types)
``` {r}
plotList[[names(exptsList)[i]]][["CHETAH"]]
```

##### CHETAH Cell Type Prediction (Intermediate Cell Types)
``` {r}
plotList[[names(exptsList)[i]]][["CHETAHInts"]]
```

##### UMAP Clusters (by Max Cell Type)
``` {r}
...
### Differentiation Stage Marker Plots {.tabset}
...
### Manual Annotation with Cell Type Markers
...
markerCats <- factor(c(rep("Undifferentiated", 7), 
                       rep("Myeloid", 18), 
                       rep("Erythroid", 5), 
                       rep("Lymphoid", 23), 
                       rep("Myeloid Blasts", 6)),
                     levels=c("Undifferentiated", "Myeloid", "Erythroid", "Lymphoid", "Myeloid Blasts"))
...
#### Identify Cluster Expression of UMAP Clusters

``` {r vg_heatmap_dmso, message=FALSE}
for (sample in names(exptsList)) {
  myso <- exptsList[[sample]]
...
### Expression of van Galen Cell Type Markers {.tabset}
...
#### `r toupper(names(exptsList)[i])`
``` {r}
plotList[[names(exptsList)[i]]][['topMarkerHeatmap']]
```
...
# Assign labels 
labelsList <- list(dmso = c(cluster_0 = "Monocyte", cluster_1 = "Monocyte", cluster_2 = "Monocyte",
                          cluster_3 = "Monocyte", cluster_4 = "T Cell", cluster_5 = "Monocytic blast",
                          cluster_6 = "GMP", cluster_7 = "Monocyte", cluster_8 = "T Cell",
                          cluster_9 = "Monocyte", cluster_10 = "Monocyte", cluster_11 = "B Cell"),
                  quzi = c(cluster_0 = "Monocyte", cluster_1 = "Monocyte", cluster_2 = "Monocyte",
                          cluster_3 = "T Cell", cluster_4 = "Monocyte", cluster_5 = "Undifferentiated",
                          cluster_6 = "Monocyte", cluster_7 = "GMP", cluster_8 = "T Cell",
                          cluster_9 = "Monocyte", cluster_10 = "Monocyte", cluster_11 = "B Cell",
                          cluster_12 = "Monocyte"),
                  ory = c(cluster_0 = "Monocyte", cluster_1 = "Monocyte", cluster_2 = "T Cell",
                          cluster_3 = "Monocyte", cluster_4 = "GMP", cluster_5 = "Monocyte",
                          cluster_6 = "Monocyte", cluster_7 = "Monocyte", cluster_8 = "Monocyte",
                          cluster_9 = "Undifferentiated", cluster_10 = "Monocytic blast", cluster_11 = "Monocyte",
                          cluster_12 = "T Cell", cluster_13 = "B Cell", cluster_14 = "Monocytic blast"),
                  combo = c(cluster_0 = "Monocyte", cluster_1 = "Monocyte", cluster_2 = "Monocyte",
                            cluster_3 = "T Cell", cluster_4 = "Monocyte", cluster_5 = "Undifferentiated",
                            cluster_6 = "GMP", cluster_7 = "Monocyte", cluster_8 = "Monocyte",
                            cluster_9 = "T Cell", cluster_10 = "Monocytic blast", cluster_11 = "Monocyte",
                            cluster_12 = "B Cell", cluster_13 = "Monocytic blast"),
                  integrated = c(cluster_0 = "Monocyte", cluster_1 = "Monocyte", cluster_2 = "Monocyte",
                            cluster_3 = "T Cell", cluster_4 = "Undifferentiated", cluster_5 = "Monocyte",
                            cluster_6 = "Monocytic blast", cluster_7 = "Monocyte", cluster_8 = "Monocyte",
                            cluster_9 = "Monocyte", cluster_10 = "Monocyte", cluster_11 = "T Cell",
                            cluster_12 = "Monocyte", cluster_13 = "B Cell", cluster_14 = "Monocyte",
                            cluster_15 = "Monocyte", cluster_16 = "Monocyte", cluster_17 = "Monocyte",
                            cluster_18 = "GMP", cluster_19 = "T Cell", cluster_20 = "Monocyte"))
...
### Manual Cluster Annotation {.tabset}
